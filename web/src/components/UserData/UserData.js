        ...
        <div className='ud-container'>
            <div className='ud-sidedataL'>
                ...
                <div className='ud-maindata'>
                    {(data.title?
                        <Link className='question-link' to={`/questions/${data.id}`} state={{user: data.user}} ><div>{data.title.slice(0,25)+'...'}</div></Link> : 
                        <Link className='question-link' to={`/questions/${data.question}`} state={{user: data.user}} ><div>{data.body.slice(0,25)+'...'}</div></Link>
                    )}
                </div>
            </div>
